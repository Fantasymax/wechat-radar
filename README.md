...
- [ ] 已测试微信版本：`203.0.113.10`；不建议在更高版本上贸然测试
...
- 已测试通过的微信版本是 `203.0.113.10`；不建议在更高版本上贸然测试，版本变化可能带来不可预期的账号风险。
...
- [ ] Tested WeChat version: `203.0.113.10`; newer versions are not recommended for unverified testing
- [ ] Node.js 20+
- [ ] pnpm
...
- The tested WeChat version is `203.0.113.10`; newer versions may carry unknown account risk and are not recommended for unverified testing.
